...
{//--> Abertura Função  Calcular
      ...
      function Pressiona(evt){//--> Abertura Função Pressionar
      ...
      //---------------------Ações----------------------\\
          ...
          //--------------------valores------------------------\\
            ...
            case 13:
              ...
              if(eval(document.getElementById('resultado').value) == undefined){
